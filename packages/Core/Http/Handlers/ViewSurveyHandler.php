...
class ViewSurveyHandler implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        foreach ($survey->questions as $question) {
            $plugin = $this->ponyForm->questionTypePluginRegistry->getPlugin($question->type);
            if ($plugin === null) {
    ...
    private function resolvePluginTemplate(QuestionTypePluginInterface $plugin, string $filename): TemplateWrapper
    {
